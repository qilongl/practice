...
import com.lql.xml.XMLAnalyzer.service.expression.ForeachExpression;
import com.lql.xml.XMLAnalyzer.service.expression.IfExpression;
...
public class ExpressionUtil {
    ...
    public static String calExpression(Action cmd, BusiConfig busiConfig, JSONObject inAllParams, Map<String,Object> inParams, Map paramMap) throws Exception {
        // 得到sql正文
     ...
     * @return
     */
    public static String calOuterExpression(String sql, BusiConfig busiConfig, JSONObject inAllParams, Map<String,Object> inParams, Map paramMap) throws Exception {
        // 取最外层表达式
        ...
        switch (expressionName) {
            case If:
                ...
                break;
            case Foreach:
                sql = ForeachExpression.exec(sql, busiConfig, inAllParams, inParams, paramMap);
                break;
            default:
                break;
        }
    ...
    public static boolean calExpression(String expression, BusiConfig busiConfig, JSONObject inAllParams, Map<String,Object> jsonObject) {
        /***
         * 去掉表达式中的参数符号
         */
     ...
     * @return
     */
    public static String setParams(Action action, String sql, Map<String,Object> jsonObject, List<Object> paramList, Map paramMap, BusiConfig busiConfig, JSONObject allInParams) {
        StringBuffer stringBuffer = new StringBuffer(sql);
     ...
     * @return
     */
    public static StringBuffer replaceParam(Action action, StringBuffer sql, Map<String,Object> jsonObject, List<Object> paramList, Map paramMap, BusiConfig busiConfig, JSONObject allInParams) {
     ...
     * @return
     */
    public static Map<String, Object> getMapObject(BusiConfig busiConfig, JSONObject allInParams, String paramName) {
     ...
     * @return
     */
    public static StringBuffer setParamsForJSONObject(Action action, String content, StringBuffer sqlBuffer, String startStr, String endStr, List paramsList, Map<String,Object> jsonObject, BusiConfig busiConfig, JSONObject allInParams) {
     ...
     * @return
     */
    public static StringBuffer setParamsForList(Action action, String content, StringBuffer sqlBuffer, String startStr, String endStr, List paramsList, Map<String,Object> jsonObject, BusiConfig busiConfig, JSONObject allInParams) {
        String name;
        String prop;
        if (content.indexOf(".") != -1) {
...
//    }
     ...
     * @throws Exception
     */
//    public static String execIf(String content, Action action, JSONObject inParams, BusiConfig busiConfig, List paramsList) throws Exception {
...
//    }
     ...
     * @throws Exception
     */
//    public static String execForeach(String content, Action action, JSONObject inParams, BusiConfig busiConfig, List paramsList) throws Exception {
//        String cmdStr = content;
//        StringBuffer sqlBuffer = new StringBuffer(cmdStr);
//        StringBuffer res;
//        while (true) {
...
//    }
     ...
     * @return
     */
//    public static StringBuffer replaceForEach(StringBuffer sqlbuffer, Action action, JSONObject inParams, BusiConfig busiConfig, List paramsList) {
...
//    }
     ...
     * @return
     */
//    private static String foreachExpression(String foreachContent, Action action, JSONObject inParams, BusiConfig busiConfig, List paramsList) {
...
//    }
     ...
     * @return
     */
//    private static StringBuffer replaceIf(StringBuffer sqlbuffer, Action action, JSONObject inParams, BusiConfig busiConfig, List paramsList) {
...
//     * @return
//     */
//    private static String ifExpression(String ifContent, Action action, JSONObject inParams, BusiConfig busiConfig, List paramsList) {
//        String params = action.getParams();
//        String key = "";
//        /***
//         * 取出表达式
...
//    }
     ...
     * @return
     */
    public static StringBuffer getParameter(StringBuffer expression, BusiConfig busiConfig, JSONObject inAllParams) {
