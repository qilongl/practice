...
import com.lql.xml.inf.IRollBack;
...
public class DPService {
    private static Logger logger = LoggerFactory.getLogger(DPService.class);
    /****
     * 默认的数据源实例
     */
    ...
    public DPService(DataSource dataSource, int transactionType) {
        this.dataSource = dataSource;
        this.transactionType = transactionType;
    }


    public DPService(DataSource dataSource, int transactionType, IRollBack iRollBack) {
        this.dataSource = dataSource;
        this.transactionType = transactionType;
    ...
    public DPService(DataSource dataSource) {
        this.dataSource = dataSource;
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        System.out.println(DPService.class);
//        SysProperties.init();
...
//         * 使用DPServcie工厂创建
//         */
//        List list = DPFactory.createDPService("test").select("select * from reports");
...
//        dpService.setDataSourceName("test");
////        dpService.startTransaction();
//        dpService.injectRollback(new Test(), "入参");
//        int num = dpService.update("delete from multifiletable  where id=6");
//        System.out.println(num);
//        Object point1 = dpService.createSavePoint();
//        num = dpService.update("delete from multifiletable  where id=7");
//        System.out.println(num);
//        Object point2 = dpService.createSavePoint();
//        dpService.rollbackToSavePoint(point1);
//        dpService.commit();
